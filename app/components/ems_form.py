...
def ems_section_nav_item(
    ...
    return rx.el.button(
        rx.icon(
            ...
            size=20,
            class_name=rx.cond(
                EmsState.active_ems_section == section_key,
                "text-blue-600",
        ...
        rx.el.span(
            ...
            class_name=rx.cond(
                EmsState.active_ems_section == section_key,
                "text-xs sm:text-sm font-medium text-blue-600 mt-1",
                "text-xs sm:text-sm font-medium text-gray-500 group-hover:text-blue-600 transition-colors mt-1",
            ),
        ),
        ...
        class_name=rx.cond(
            EmsState.active_ems_section == section_key,
            "flex flex-col items-center p-2 sm:p-3 rounded-lg bg-blue-50 group border-b-2 border-blue-600 transition-all duration-150 ease-in-out min-h-[56px] min-w-[56px] justify-center",
            "flex flex-col items-center p-2 sm:p-3 rounded-lg hover:bg-gray-100 group border-b-2 border-transparent transition-all duration-150 ease-in-out min-h-[56px] min-w-[56px] justify-center",
        ),
        type="button",
    )
...
def form_input(
    ...
    **kwargs
    ...
    input_class_name = "mt-1 block w-full rounded-md border border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-base px-4 py-3 transition-shadow h-12"
    return rx.el.div(
        rx.el.label(
            label,
...
def form_select(
    ...
    outer_class_name = kwargs.pop("class_name", "")
    select_class_name = "mt-1 block w-full rounded-md border border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-base px-4 py-3 transition-shadow h-12 appearance-none pr-8 bg-no-repeat bg-right-2"
    return rx.el.div(
        rx.el.label(
            label,
            class_name="block text-sm font-medium text-gray-700 mb-1",
...
def form_textarea(
    ...
    **kwargs
    ...
    outer_class_name = kwargs.pop("class_name", "")
    textarea_class_name = "mt-1 block w-full rounded-md border border-gray-300 bg-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-base px-4 py-3 transition-shadow"
    return rx.el.div(
        rx.el.label(
            label,
            class_name="block text-sm font-medium text-gray-700 mb-1",
...
def ems_section_content(section_key: str) -> rx.Component:
    ...
    dispatch_grid = "grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 p-4 sm:p-6"
    arrival_grid = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4 p-4 sm:p-6"
    assessment_grid = "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-4 p-4 sm:p-6"
    treatment_grid = "p-4 sm:p-6 space-y-6"
    transport_grid = "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-4 p-4 sm:p-6"
    return rx.match(
        section_key,
        (
            "Dispatch",
            rx.el.div(
                ...
                form_select(
                    ...
                    class_name="col-span-1 sm:col-span-1",
                ),
                form_select(
                    "Response Delay",
        ...
        (
            ...
            rx.el.div(
                ...
                rx.el.h4(
                    "OPQRST",
                    class_name="col-span-full text-md font-semibold text-gray-700 mt-4 mb-2 border-t pt-4",
                ),
                form_input(
                    "Onset",
        ...
        (
            ...
            rx.el.div(
                rx.el.div(
                    rx.el.label(
                        rx.el.input(
                            ...
                            class_name="mr-2 rounded border-gray-400 text-blue-600 shadow-sm focus:ring-blue-500 h-5 w-5",
                        ),
                        "Vitals WNL",
                        class_name="inline-flex items-center text-base font-medium text-gray-700 cursor-pointer p-2",
                    ),
                ...
                form_input(
                    "Heart Rate",
                    lambda v: EmsState.set_hr(v.to(int)),
                ...
                form_input(
                    "Respirations",
                    lambda v: EmsState.set_rr(v.to(int)),
        ...
        (
            ...
            rx.el.div(
                rx.el.fieldset(
                    rx.el.legend(
                        "Protocols Selected",
                        class_name="block text-sm font-medium text-gray-700 mb-2 font-semibold",
                    ),
                    rx.el.div(
                        rx.foreach(
                            EmsState.protocols,
                            lambda protocol: rx.el.label(
                                ...
                                protocol,
                                class_name="inline-flex items-center mr-4 mb-2 text-base text-gray-700 cursor-pointer p-1",
                            ),
                        ),
                ...
                rx.el.fieldset(
                    rx.el.legend(
                        ...
                        class_name="block text-sm font-medium text-gray-700 mb-2 font-semibold border-t pt-4 mt-4",
                    ),
                    rx.el.div(
                        rx.foreach(
                ...
                rx.el.fieldset(
                        ...
                        rx.foreach(
                            ...
                            lambda med_entry, index: rx.el.div(
                                ...
                                rx.el.button(
                                    ...
                                    class_name="p-3 rounded-md text-red-600 hover:bg-red-100 transition-colors flex-shrink-0 self-end mb-1 h-12 w-12 flex items-center justify-center",
                                ),
                    ...
                    rx.el.button(
                        ...
                        type="button",
                        class_name="inline-flex items-center gap-2 px-5 py-3 border border-gray-300 rounded-md shadow-sm text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500",
                    ),
                ),
        ...
        (
            ...
            rx.el.div(
                ...
                class_name=transport_grid,
            ),
        ),
        rx.el.div(
            "Select a section",
            class_name="p-6 text-gray-500 text-center",
        ),
    )
    ...
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.div(
                ...
                class_name="grid grid-cols-5 gap-1 sm:gap-2 border-b border-gray-200 bg-gray-50 p-1 sm:p-2 sticky top-0 z-10",
            ),
            rx.scroll_area(
                ems_section_content(
            ...
            rx.el.div(
                rx.el.button(
                    ...
                    class_name="w-full px-6 py-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150 ease-in-out min-h-[50px]",
                ),
